    ...
    if (!$page_data) {
        ...
        <div style='text-align:center; padding-top:100px; font-family:sans-serif; color:#334155; background:#f8fafc; height:100vh;'>
            <div style='background:white; display:inline-block; padding:40px; border-radius:20px; shadow:0 10px 15px -3px rgba(0,0,0,0.1); border:1px solid #e2e8f0;'>
                ...
                <p style='color:#64748b; max-width:400px; line-height:1.6;'>The URL you requested does not exist.</p>
...
<head>
    ...
    <style>
        ...
        .content-viewport img, .content-viewport video { max-width: 100%; height: auto; object-fit: cover; }
    </style>
</head>
<body>
...
<script>
    ...
    function generateViewHTML(type, content, extra = '') {
        ...
        // ADDED VIDEO SUPPORT
        if (type === 'video') {
            view = `<video src="${content}" class="${extra}" autoplay muted loop playsinline></video>`;
        }
