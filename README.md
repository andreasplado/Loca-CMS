...
### D.
The Public Renderer (index.php)The performance-optimized "visitor" side of the CMS. It reads the JSON array and loops through it to generate a clean, static-like website for the end user without the overhead of the builder's JavaScript.
